...
var Indicator = function(settings) {
  ...
  // console.debug("Created LRC indicator with h: ", this.depth);
}
...
Indicator.prototype.update = function(price) {
  ...
  if(this.result === false && this.age < this.depth) {
    ...
    this.age++;
    this.result = false;
     // console.debug("Waiting for sufficient age: ", this.age, " out of ", this.depth);
    //
    return;
  }
  ...
  // console.debug("Checking LRC: ", this.result.toFixed(8), "\tH: ", this.age);
  return;
}
